  ...
  sc: {
    ...
    features: {
      ...
      items: [
        ...
        {
          title: '符合国内外标准的元数据导出',
          desc: '原生支持国际音频档案标准 IASA-TC 04 / IMDI，并符合中国 GB/T 31219.4 与档案行业标准 DA/T 63；一键导出田野报告（JSON / XML / CSV）：档案编号、项目名称、传承人、采集时间、地区、类别、技术信息——让每段声音都按国内外标准著录、可长期存档、可溯源，直接提交期刊与档案馆。',
          tag: 'GB/T · IASA-TC04 · IMDI',
        },
        {
          title: '极限弱设备适配',
          desc: '免于 Python 运行环境配置、模型内置（Offline-First）、内置 FFmpeg、向量化 DSP 与流式处理——田野无网、设备老旧，也能顺畅分析 30 分钟长录音。',
          tag: 'Offline-First',
        },
      ],
    },
  ...
  tc: {
    ...
    features: {
      ...
      items: [
        ...
        { title: '符合國內外標準的元資料匯出', desc: '原生支援國際音訊檔案標準 IASA-TC 04 / IMDI，並符合中國 GB/T 31219.4 與檔案行業標準 DA/T 63；一鍵匯出田野報告（JSON / XML / CSV）：檔案編號、專案名稱、傳承人、採集時間、地區、類別、技術資訊——讓每段聲音都按國內外標準著錄、可長期儲存、可溯源，直接提交期刊與檔案館。', tag: 'GB/T · IASA-TC04 · IMDI' },
        { title: '極限弱設備適配', desc: '免於 Python 執行環境設定、模型內建（Offline-First）、內建 FFmpeg、向量化 DSP 與串流處理——田野無網、設備老舊，也能順暢分析 30 分鐘長錄音。', tag: 'Offline-First' },
      ],
    },
    screenshots: {
    ...
    features: {
      ...
      items: [
        ...
        },
        {
          ...
          desc: 'No Python environment setup required, bundled models (Offline-First), bundled FFmpeg, vectorized DSP and streaming — analyze a 30-minute recording offline on old hardware.',
          tag: 'Offline-First',
        },
      ],
    },
